...
public class HeaderModule extends BasePage {
    ...
    public boolean isBriefcaseLogoVisible(){ return briefcaseLogo.isDisplayed();}

    public boolean isJoinUsVisible(){ return joinUs.isDisplayed();}

    public String joinUsLink(){ return joinUs.getAttribute("href");}

    public String joinUsText() {return joinUs.getText();}

    public boolean isLogoVisible(){ return logo.isDisplayed();}

    public String headerLogoPosition() { return String.valueOf(logo.getLocation());}
