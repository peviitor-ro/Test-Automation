...
public class LandingPage extends BasePage
{
    ...
    public static void verifyIfNewTabOpens(WebDriver driver, String page)
    {
    ...
    public static WebElement alatura_te()
    {
    ...
    public static String test_diacritics()
    {
        return avem().getText();
    }

    public static String teste_diacritics()
    {
        return alatura_te().getText();
    }
