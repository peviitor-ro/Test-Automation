...
//    {
//        assertEquals(landingPage.joinFontStyle(), "normal");
//    }
//
...
//    {
//        assertEquals(landingPage.joinColor(), "rgba(9, 10, 10, 1)");
//    }
//
...
//    {
//        assertEquals(landingPage.joinFontWeight(), "400");
//    }
//
...
//    {
//        assertEquals(landingPage.joinLetter(), "normal");
//    }
//
...
//    {
//        assertEquals(landingPage.joinFontSize(), "16px");
//    }
//
...
//    {
//        alaturate_redirect();
//        LandingPage.verifyIfNewTabOpens(driver, VOLUNTARI);
//    }
//
...
//    {
//        landingPage.alaturateCauzeiTap();
//        LandingPage.verifyIfNewTabOpens(driver, VOLUNTARI);
//    }
//
...
//    {
//        String s = LandingPage.teste_diacritics();
...
//    {
//        facebookTap();
//        verifyIfNewTabOpens(driver, FACEBOOK);
//    }
//
...
//    {
//        assertEquals(landingPage.jobText(), "jobul dorit");
//    }
//
...
//    {
//        assertEquals(landingPage.jobFont(), "PoppinsRegular");
//    }
//
...
//    {
//        assertEquals(landingPage.jobFontStyle(), "normal");
//    }
//
...
//    {
//        assertEquals(landingPage.jobFontSize(), "26px");
//    }
//
...
//    {
//        assertEquals(landingPage.jobLine(), "32px");
//    }
//
...
//    {
//        assertEquals(landingPage.jobColor(), "rgba(224, 141, 34, 1)");
//    }
//
...
//    {
//        String s = LandingPage.test_diacritics();
//        Normalizer.isNormalized(s, Normalizer.Form.NFD);
//    }
//
//
...
//    {
//        assertEquals(landingPage.avemFontWeight(), "400");
//    }
//
...
//    {
//        assertEquals(landingPage.avemFontSize(), "16px");
//    }
//
//
...
//    {
//        assertEquals(landingPage.avemFontStyle(), "normal");
//    }
//
...
//    {
//        despreTap();
//        verifyIfNewTabOpens(driver, ONG);
//    }
//
...
//    {
//        conditiiTap();
//        verifyIfNewTabOpens(driver, CONDITII);
//    }
//
...
//    {
//        politicaTap();
//        verifyIfNewTabOpens(driver, PRIVACY);
//    }
//
